...
**Tradition/source:** Nursery rhyme, trad (pre-1850)
**Public domain:** Yes - pre-1929 US or original MIT
**Arrangement:** Starter L2 arrangement for `andean-duct-flutes`.

## Range check
D4-G4: within the beginner starter range for this packet.

## Practice tip
Use even breath pulses; every repeated note should still have a clean start.
